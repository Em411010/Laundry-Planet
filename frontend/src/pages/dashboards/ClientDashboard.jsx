        ...
        <div className="max-w-7xl mx-auto">
          <div className="card bg-base-100 shadow-xl mt-12">
            <div className="card-body items-center text-center">
              ...
              <p className="text-lg text-base-content/70 mb-6">Client Dashboard</p>
              ...
              <div className="mt-8 text-base-content/60">
                <p>Your client portal is being built with amazing features:</p>
                <ul className="list-disc list-inside mt-4 space-y-2">
                  <li>Place new laundry orders</li>
